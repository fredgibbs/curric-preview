...
## 1. Make Expectations Visible and Consistent
...
Curriculum proposals vary in consequence. A course description update should not require the same amount of proposal preparation or take as much reviewer time as a program revision.
...
## 3. Define Clear Review Stages and Responsibilities

Most proposals move through similar formal stages: department, technical review, college review, Faculty Senate review, and final administrative review. This recommendation endorses **division of responsibility**---what each stage is expected to review in accordance with the proposal type.

A clearer division of responsibility would allow:

- Departments review academic coherence and local feasibility.
- Technical review checks form readiness and catalog/workflow issues.
- Colleges review programmatic fit, advising, resources, and intra-college coordination.
- Senate bodies review university-wide academic and governance questions.
- The Provost’s Office reviews institutional commitments and final alignment.

Recurring returns are evidence the system may need clearer prompts, better examples, training, form changes, or a different consultation point — not just a better proposal.

{% include typography/callout.html class="warning" title="Key point" text="Downstream reviewers need to be able to trust upstream review stages. If a Senate committee is hunting for credit hour statements, it has less capacity to do Senate-level review across the whole curriculum.
" %}
...
## 4. Use Related Reviews Without Overreaching

Curriculum review should connect to related academic processes. This is a balance: proposals should draw on program review, assessment, accreditation, and planning where relevant, but curriculum workflow should not become a general-purpose review of course quality, instructional design, or syllabus language.

### Connect to existing reviews

Program review, assessment, accreditation, advisory boards, and other formal reviews should have operational consequence. When a proposal responds to those processes, the proposal is stronger and easier to evaluate. For program-level changes, reviewers should expect to see whether the proposal is informed by:

- Academic Program Review
- Student learning outcomes assessment
- Accreditation or licensure review
- External or advisory-board feedback
- Student demand or field developments

### Keep curriculum review within scope

Proposal review should focus on broader curricular elements like learning outcomes, course goals, credit hours, grading mode, prerequisites, program requirements, student impact, resource implications, and institutional fit.

Requiring a syllabus for curriculum review sends the message that committees are evaluating course design — which they are not positioned to do well, and which belongs elsewhere. Curriculum review should focus on curricular implications; instructional design questions deserve their own venue through a teaching and learning body or similar process.

{% include typography/callout.html class="warning" title="Key point" text="Curriculum review should be informed by related academic reviews, but it should not become syllabus language policing." %}

{% capture review_boundary_recommendations %}
- **Connect proposals to assessment, accreditation, and planning.** APR, assessment, accreditation, and strategic planning should inform the rationale where relevant.
...
## 5. Improve Kuali Form Prompts

Form field descriptions shape what submitters think reviewers need. A vague or narrow prompt produces generic answers. Well-framed fields reduce avoidable returns and make review more substantive. For example:

- A justification prompt should ask what prompted the change, what evidence supports it, and what outcome is expected.
- A budget prompt should ask about sustainability, not only new money.
- A duplication prompt should ask about collaboration, overlap, and curricular design, not simply whether a duplicate exists.
