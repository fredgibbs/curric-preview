---
title: Curriculum Workflow Guide
layout: unm
document: true
---

# Curriculum Workflow Guide

This guide is for anyone preparing a curriculum proposal — from a small catalog correction to a new program. It explains what each proposal type requires, what should happen before you submit, and how formal review works.

---

## Quick Start

If you are preparing a proposal:
...
4. Work with the authorized departmental submitter to enter the proposal in Kuali.
...
- Relationship to existing UNM offerings.
...
| Catalog language | ✓ | ✓ | ✓ | ✓ |
| Structured SLOs, credit hours, grading mode, course goals | — | ✓ | as relevant | as relevant |
| Rationale / justification | brief | ✓ | ✓ | ✓ |
| APR / assessment / accreditation linkage | — | as relevant | ✓ | ✓ |
| Resource and sustainability statement | — | as relevant | ✓ | ✓ |
| Advising and degree-progression impact | — | — | ✓ | ✓ |
| Cross-unit consultation record | — | as relevant | ✓ | ✓ |
| Associate Dean consultation record | — | — | ✓ | ✓ |
| Provost concept discussion reference | — | — | — | ✓ |
| Concept paper or equivalent planning document | — | — | — | ✓ |
| Implementation plan | — | — | as relevant | ✓ |
| External requirements | — | — | as relevant | ✓ |

---

## Submitter Authorization

Formal submission should be limited to designated departmental submitters, typically the chair of the departmental curriculum committee or another designated faculty curriculum lead.

- Faculty proposers may develop proposals without serving as the formal submitter.
- Submission indicates departmental curriculum committee endorsement or equivalent authorization.
- Departments should maintain a current authorized-submitter roster.
- Procedures for updating rosters should be straightforward.
